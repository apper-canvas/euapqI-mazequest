...
import DailyChallengeView from './pages/DailyChallengeView'
import { DailyChallengeProvider } from './context/DailyChallengeContext'
      ...
      <div className="min-h-screen font-sans text-surface-800 dark:text-surface-100 transition-colors duration-300">
        ...
        <main>
          <Routes>
            ...
            <Route path="/daily-challenge" element={<DailyChallengeView />} />
